...
Windows má vlastní malé grafické rozhraní. Hotový balíček je dostupný také v **[GitHub Releases](https://github.com/CaseyCZ/PiTV/releases/latest)** jako `PiTV-SD-Installer-Windows-v1.3.2.zip`.
