...
rm -f /usr/local/bin/pitv-session /usr/local/bin/pitv-waydroid-launch /usr/local/libexec/pitv-helper /usr/local/libexec/pitv-self-update /usr/local/libexec/pitv-install-waydroid
