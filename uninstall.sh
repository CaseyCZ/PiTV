...
rm -f /usr/local/bin/pitv-session /usr/local/bin/pitv-session-run /usr/local/bin/pitv-waydroid-launch /usr/local/bin/pitv-kodi-addon /usr/local/libexec/pitv-helper /usr/local/libexec/pitv-self-update /usr/local/libexec/pitv-install-waydroid /usr/local/libexec/pitv-cec-monitor
