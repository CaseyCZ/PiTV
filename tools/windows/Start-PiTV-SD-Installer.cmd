...
set "PITV_API=https://api.github.com/repos/%PITV_REPO%/releases/tags/alpha"
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$asset=$r.assets | Where-Object name -eq 'PiTV-SD-Installer-Windows.zip' | Select-Object -First 1;" ^
  "if(-not $asset){ throw 'PiTV Alpha neobsahuje instalační ZIP.' }" ^
